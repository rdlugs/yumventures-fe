      ...
      <div className="grid md:grid-cols-2 items-center gap-12">
        <div>
          ...
          <p className="mt-1 md:text-lg text-gray-800 dark:text-neutral-200">
            Take control of your POS, inventory, and menu management with our
            all-in-one system, designed to save you time, reduce waste, and
            ...
            <ul className="mt-2 space-y-2">
              <li className="flex gap-x-3">
                ...
                <span className="text-gray-600 dark:text-neutral-400">
                  Effortless POS system that streamlines orders, payments, and
                  customer interactions, so you can focus on delivering great
                  food.
                </span>
              </li>
              ...
              <li className="flex gap-x-3">
                ...
                <span className="text-gray-600 dark:text-neutral-400">
                  Real-time inventory management to prevent stockouts and waste,
              ...
              <li className="flex gap-x-3">
                ...
                <span className="text-gray-600 dark:text-neutral-400">
                  Menu management tools that allow you to easily update and
                  personalize your offerings, keeping customers coming back for
                  more.
                </span>
              </li>
            </ul>
          ...
          <div className="mt-10 flex items-center gap-x-5">
            ...
            <span className="text-sm text-gray-500 dark:text-neutral-500">
              Trusted by over 800 restaurants
            </span>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-10 dark:border-neutral-700">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-neutral-200">
              Ready to take your restaurant to the next level? Let’s talk.
            </h2>
