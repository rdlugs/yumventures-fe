              ...
              <div className="sm:col-span-2 md:grow">
                <div className="flex justify-end gap-x-2">
                  ...
                  <div className="hs-dropdown [--placement:bottom-right] relative inline-block">
                    ...
                    <div className=" transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden divide-y divide-gray-200 min-w-48 z-10 bg-white shadow-md rounded-lg mt-2 dark:divide-neutral-700 dark:bg-neutral-800 dark:border dark:border-neutral-700">
